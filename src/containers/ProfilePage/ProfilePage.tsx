			...
			<div className={style.content}>
				...
				<div className={style.description}>
					<p>
						...
						На четвертом курсе меня заинтересовало программирование и первоначально я выбрал курс
						на hexlet &#34;Основы программирования&#34;. Базовым языком курса был JavaScript.
